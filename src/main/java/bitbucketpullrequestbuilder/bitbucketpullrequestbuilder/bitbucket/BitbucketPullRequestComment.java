...
public class BitbucketPullRequestComment implements Comparable<BitbucketPullRequestComment> {
    ...
    public String toString() {
        return new StringBuilder().append("BitbucketPullRequestComment [isEntityAuthor=").append(isEntityAuthor)
            .append(", pullRequestId=").append(pullRequestId).append(", contentRendered=").append(contentRendered)
            .append(", deleted=").append(deleted).append(", UtcLastUpdated=").append(UtcLastUpdated)
            .append(", commentId=").append(commentId).append(", content=").append(content).append(", UtcCreatedOn=")
            .append(UtcCreatedOn).append(", isSpam=").append(isSpam).append(", author=").append(author).append("]")
            .toString();
    }
