...
public class BitbucketPullRequestResponseValue {
    ...
    @JsonProperty("merge_commit")
    public void setMergeCommit(BitbucketPullRequestResponseValueRepositoryCommit mergeCommit) {
    ...
    public String toString() {
        return new StringBuilder().append("id=").append(id).append(", title=").append(title).append(", description=")
            .append(description).append("closeSourceBranch=").append(closeSourceBranch).append(", destination=")
            .append(destination).append(", reason=").append(reason).append(", closedBy=").append(closedBy)
            .append(", source=").append(source).append(", state=").append(state).append(", createdOn=")
            .append(createdOn).append(", updatedOn=").append(updatedOn).append(", mergeCommit=").append(mergeCommit)
            .toString();
    }
}
